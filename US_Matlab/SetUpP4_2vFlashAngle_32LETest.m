...
Resource.DisplayWindow(1).Title = 'P4-2vExperimental';
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'focus', 300, ... %-P.radius, ...     % set focus to negative for concave TX.Delay profile.
                   'Steer', [0.0,0.0], ...
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    Event(n).info = 'Acquire 2nd half aperture';
    Event(n).tx = j;
    Event(n).rcv = k+2*j;
    Event(n).recon = 0;
    Event(n).process = 0;
