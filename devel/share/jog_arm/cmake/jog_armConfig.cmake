...
if("TRUE" STREQUAL "TRUE")
  set(jog_arm_SOURCE_PREFIX /home/haoran/US_UR3/src/jog_arm)
  set(jog_arm_DEVEL_PREFIX /home/haoran/US_UR3/devel)
  set(jog_arm_INSTALL_PREFIX "")
  set(jog_arm_PREFIX ${jog_arm_DEVEL_PREFIX})
else()
  set(jog_arm_SOURCE_PREFIX "")
  set(jog_arm_DEVEL_PREFIX "")
  set(jog_arm_INSTALL_PREFIX /home/haoran/US_UR3/install)
...
if(NOT "/home/haoran/US_UR3/src/jog_arm/include " STREQUAL " ")
  set(jog_arm_INCLUDE_DIRS "")
  set(_include_dirs "/home/haoran/US_UR3/src/jog_arm/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'jog_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haoran/US_UR3/src/jog_arm/${idir}'.  ${_report}")
    endif()
