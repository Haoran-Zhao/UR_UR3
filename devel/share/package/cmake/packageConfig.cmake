...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/haoran/US_UR3/src/simulation_ur3)
  set(package_DEVEL_PREFIX /home/haoran/US_UR3/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/haoran/US_UR3/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haoran/US_UR3/src/simulation_ur3/${idir}'.  ${_report}")
    endif()
