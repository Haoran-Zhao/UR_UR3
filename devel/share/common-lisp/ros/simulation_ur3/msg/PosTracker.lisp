...
(cl:defmethod cl:initialize-instance :after ((m <PosTracker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PosTracker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation_ur3-msg:<PosTracker> is deprecated: use simulation_ur3-msg:PosTracker instead.")))

(cl:ensure-generic-function 'c_X-val :lambda-list '(m))
(cl:defmethod c_X-val ((m <PosTracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:c_X-val is deprecated.  Use simulation_ur3-msg:c_X instead.")
  (c_X m))

(cl:ensure-generic-function 'c_Y-val :lambda-list '(m))
(cl:defmethod c_Y-val ((m <PosTracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:c_Y-val is deprecated.  Use simulation_ur3-msg:c_Y instead.")
  (c_Y m))

(cl:ensure-generic-function 'c_Z-val :lambda-list '(m))
(cl:defmethod c_Z-val ((m <PosTracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:c_Z-val is deprecated.  Use simulation_ur3-msg:c_Z instead.")
  (c_Z m))

(cl:ensure-generic-function 'g_X-val :lambda-list '(m))
(cl:defmethod g_X-val ((m <PosTracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:g_X-val is deprecated.  Use simulation_ur3-msg:g_X instead.")
  (g_X m))

(cl:ensure-generic-function 'g_Y-val :lambda-list '(m))
(cl:defmethod g_Y-val ((m <PosTracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:g_Y-val is deprecated.  Use simulation_ur3-msg:g_Y instead.")
  (g_Y m))

(cl:ensure-generic-function 'g_Z-val :lambda-list '(m))
(cl:defmethod g_Z-val ((m <PosTracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:g_Z-val is deprecated.  Use simulation_ur3-msg:g_Z instead.")
  (g_Z m))
