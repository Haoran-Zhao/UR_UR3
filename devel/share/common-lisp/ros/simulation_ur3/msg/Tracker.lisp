...
(cl:defmethod forward-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:forward-val is deprecated.  Use simulation_ur3-msg:forward instead.")
  (forward m))

(cl:ensure-generic-function 'backward-val :lambda-list '(m))
(cl:defmethod backward-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:backward-val is deprecated.  Use simulation_ur3-msg:backward instead.")
  (backward m))

(cl:ensure-generic-function 'init_joint-val :lambda-list '(m))
(cl:defmethod init_joint-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:init_joint-val is deprecated.  Use simulation_ur3-msg:init_joint instead.")
  (init_joint m))

(cl:ensure-generic-function 'init_position-val :lambda-list '(m))
(cl:defmethod init_position-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation_ur3-msg:init_position-val is deprecated.  Use simulation_ur3-msg:init_position instead.")
  (init_position m))
