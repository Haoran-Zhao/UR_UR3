...
if("TRUE" STREQUAL "TRUE")
  set(jog_msgs_SOURCE_PREFIX /home/haoran/US_UR3/src/jog_control/jog_msgs)
  set(jog_msgs_DEVEL_PREFIX /home/haoran/US_UR3/devel)
  set(jog_msgs_INSTALL_PREFIX "")
  set(jog_msgs_PREFIX ${jog_msgs_DEVEL_PREFIX})
else()
  set(jog_msgs_SOURCE_PREFIX "")
  set(jog_msgs_DEVEL_PREFIX "")
  set(jog_msgs_INSTALL_PREFIX /home/haoran/US_UR3/install)
...
if(NOT "/home/haoran/US_UR3/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/jog_msgs " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/jog_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'jog_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haoran/US_UR3/src/jog_control/jog_msgs/${idir}'.  ${_report}")
    endif()
