# Install script for directory: /home/haoran/US_UR3/src/jog_arm
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/haoran/US_UR3/build/jog_arm/catkin_generated/installspace/jog_arm.pc")
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/jog_arm/cmake" TYPE FILE FILES
    "/home/haoran/US_UR3/build/jog_arm/catkin_generated/installspace/jog_armConfig.cmake"
    "/home/haoran/US_UR3/build/jog_arm/catkin_generated/installspace/jog_armConfig-version.cmake"
    )
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/jog_arm" TYPE FILE FILES "/home/haoran/US_UR3/src/jog_arm/package.xml")
endif()
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/jog_arm" TYPE DIRECTORY FILES "/home/haoran/US_UR3/src/jog_arm/include/jog_arm/" FILES_MATCHING REGEX "/[^/]*\\.h$")
endif()
