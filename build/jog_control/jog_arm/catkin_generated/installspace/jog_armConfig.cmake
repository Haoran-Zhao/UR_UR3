...
if("FALSE" STREQUAL "TRUE")
  set(jog_arm_SOURCE_PREFIX /home/haoran/US_UR3/src/jog_control/jog_arm)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'jog_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haoran/US_UR3/install/${idir}'.  ${_report}")
    endif()
